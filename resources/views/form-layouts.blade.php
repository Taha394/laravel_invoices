                            ...
                            <div class="col-md-6">
                                <div class="main-form-group">
                                    <label class="form-label">Email</label> <input class="form-control"
                                                                                   ...
                                                                                   type="email"
                                                                                   value="me@sprukotechnologies.com">
                                </div><!-- main-form-group -->
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="main-dropdown-form-demo">
                        <div class="mg-t-20">
                            <button class="btn btn-main-primary pd-x-20" data-toggle="dropdown">Live Example <i
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tx-center pd-y-20 bg-gray-200">
                        <a class="btn btn-main-primary" data-target="#modaldemo1" data-toggle="modal" href="">View Live
                            Demo</a>
                    </div><!-- pd-y-30 -->
                    <div class="modal">
                            ...
                            <div class="modal-content">
                                <div class="modal-body pd-sm-40">
                                    ...
                                    <div class="form-group mg-b-25">
                                        <label class="ckbox mg-b-5"><input type="checkbox"><span class="tx-13">I agree to <a
                                                    href="">Terms</a> and <a href="">Privacy Policy</a></span></label>
                                        <label class="ckbox"><input checked type="checkbox"><span class="tx-13">Yes, I want to receive email from your newsletter.</span></label>
                                    </div>
                            ...
                            <div class="card card-body pd-20 pd-md-40 border shadow-none">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5"
                                                                                       src="{{URL::asset('assets/img/visa.png')}}">
                                            <img alt="" class="wd-30" src="{{URL::asset('assets/img/mastercard.png')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
