        ...
        <div class="col-xl-6 col-md-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="mg-b-20 tx-13 text-muted">Examples using standard <code>h1</code> to <code>h6</code> html
                        tags</p>
                </div>
                <div class="card-body pt-0">
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="typo1"><pre><code class="language-markup"><script
                                        type="html-Dashkit/script"><h1>h1. Heading</h1>
<h2>h2. Heading</h2>
<h3>h3. Heading</h3>
<h4>h4. Heading</h4>
<h5>h5. Heading</h5>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="typo2"><pre><code class="language-markup"><script
                                        type="html-Dashkit/script"><h1 class="text-primary">h1. Heading</h1>
<h2  class="text-secondary">h2. Heading</h2>
<h3  class="text-success">h3. Heading</h3>
<h4  class="text-danger">h4. Heading</h4>
<h5  class="text-info">h5. Heading</h5>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="typo3"><pre><code class="language-markup"><script
                                        type="html-Dashkit/script"><h1 class="heading-inverse">h1. Heading</h1>
<h2 class="heading-secondary">h2. Heading</h2>
<h3 class="heading-inverse">h3. Heading</h3>
<h4 class="heading-inverse">h4. Heading</h4>
<h5 class="heading-inverse">h5. Heading</h5>
        ...
        <div class="col-xl-6 col-md-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="mg-b-20 tx-13 text-muted">Examples using <code>heading-primary</code> to <code>heading-danger</code>
                        css</p>
                </div>
                <div class="card-body pt-0">
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="typo4"><pre><code class="language-markup"><script
                                        type="html-Dashkit/script"><h1 class="heading-primary">h1. Heading</h1>
<h2 class="heading-secondary">h2. Heading</h2>
<h3 class="heading-success">h3. Heading</h3>
<h4 class="heading-info">h4. Heading</h4>
<h5 class="heading-warning">h5. Heading</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table main-table-reference text-nowrap mg-t-0 mg-b-0">
                            ...
                            <tr>
                                ...
                                <td>8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 20 | 22 | 24 | ... | 140 (step of
                                    2)
                                </td>
                            </tr>
                            </tbody>
