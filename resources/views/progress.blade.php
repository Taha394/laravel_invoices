            ...
            <div class="card" id="progress">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="progress01"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="progress mg-b-20">
            ...
            <div class="card" id="progress2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="progress02"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="progress mg-b-20">
            ...
            <div class="card" id="progress6">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="progress55"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="progress progress-style ht-5 mb-4">
            ...
            <div class="card" id="progress3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="progress03"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="progress mg-b-10">
            ...
            <div class="card" id="progress04">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="progress4"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="progress mg-b-10">
