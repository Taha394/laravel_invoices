            ...
            <div class="card" id="popover">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Documentation and examples for adding Bootstrap popovers,
                            like those found in iOS, to any element on your site..</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                                ...
                                <div class="row row-sm tx-center">
                                    <div class="col-sm-6 col-lg-3">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                                ...
                                                data-original-title="Popover top">Click me
                                        </button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-sm-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                                data-toggle="popover" data-popover-color="default"
                                                data-placement="bottom" title=""
                                                data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                                data-original-title="Popover bottom">Click me
                                        </button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-lg-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                                ...
                                                title=""
                                                data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                                data-original-title="Popover left">Click me
                                        </button>
                                    </div><!-- col-3 -->
                                    <div class="col-sm-6 col-lg-3 mg-t-30 mg-lg-t-0">
                                        <button type="button" class="btn btn-secondary" data-container="body"
                                                ...
                                                data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                                data-original-title="Popover right">Click me
                                        </button>
                                    </div><!-- col-3 -->
                                </div><!-- row -->
                            </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover01"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-sm tx-center">
	<div class="col-sm-6 col-lg-3">
            ...
            <div class="card" id="popover2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover02"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-sm tx-center">
		<div class="col-sm-6 col-lg-3">
            ...
            <div class="card" id="popover3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="popover03"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-sm tx-center">
	<div class="col-sm-6 col-lg-3">
