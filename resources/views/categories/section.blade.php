        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.settings')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('messages.categories')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-11 col-md-2">
                            <button class="modal-effect btn btn-primary-gradient btn-block" data-effect="effect-scale"
                                    data-toggle="modal" href="#modaldemo8">{{__('messages.add category')}}</button>
                    ...
                    <form action="categories/update" method="post" autocomplete="off">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <label for="recipient-name" class="col-form-label">{{__('messages.category name')}}
                                    :</label>
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">{{__('messages.delete category')}}</h6>
