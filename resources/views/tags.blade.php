        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Elements</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Tags</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element01"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="tags">
	<span class="tag">First tag</span>
	<span class="tag">Second tag</span>
	<span class="tag">Third tag</span>
</script></code></pre>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element02"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-rounded">First tag</span>
	<span class="tag tag-rounded">Second tag</span>
	<span class="tag tag-rounded">Third tag</span>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element03"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-default">
		One
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element04"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="tags">
	<span class="tag tag-blue">Blue tag</span>
	<span class="tag tag-azure">Azure tag</span>
	<span class="tag tag-indigo">Indigo tag</span>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element05"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><select multiple data-role="tagsinput" class="form-control">
	<option value="jQuery">jQuery</option>
	<option value="Angular">Angular</option>
	<option value="React">React</option>
	<option value="Vue">Vue</option>
