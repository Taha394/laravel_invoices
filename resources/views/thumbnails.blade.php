                ...
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Images in Bootstrap are made responsive with .img-fluid.
                            max-width: 100%; and height: auto; are applied to the image so that it scales with the
                            parent element.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="images2"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row">
	<div class="col-6 col-md-3">
            ...
            <div class="card custom-card" id="aligning">
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Align images with the helper float classes or text
                            alignment classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="images3"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="clearfix">
            ...
            <div class="card custom-card" id="contentthumb">
                <div class="card-body ht-100p">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="images5"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row">
	<div class="col-xl-4 col-lg-4">
		<div class="img-thumbnail  mb-3">
			<a href="#">
            ...
            <div class="card custom-card" id="responsive">
                <div class="card-body ht-100p">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="images1"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('assets/img/media/7.jpg')}}"></div>
</script></code></pre>
            ...
            <div class="card custom-card" id="background">
                <div class="card-body ht-100p">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Make image as background to your content using the helper
                            or utilities classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                            <figure class="pos-relative mg-b-0">
                                ...
                                <figcaption class="pos-absolute a-0 pd-25 bg-black-5 tx-white-8">
                                    ...
                                    <p class="mg-b-0">Royalty free means you just need to pay for rights to use the item
                                        ...
                                        You dont need to pay additional or ongoing fees for each person who sees or uses
                                        it.</p>
                                </figcaption>
                            </figure>
                        </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="images4"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><figure class="pos-relative mg-b-0">
