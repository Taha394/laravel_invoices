        ...
        <div class="col-lg-6 col-md-12">
            <div class="card mg-b-20" id="list">
                <div class="card-body">
                    ...
                    <p class="mg-b-20 text-muted card-sub-title">It is Very Easy to Customize and it uses in your
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list01"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="listgroup-example ">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
            ...
            <div class="card mg-b-20" id="list1">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list02"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="listgroup-example2">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
                                ...
                                <a class="list-group-item list-group-item-action flex-column align-items-start active"
                                   href="#">
                                    ...
                                    <p class="mb-1 tx-13">Donec id elit non mi porta gravida at eget metus. Maecenas sed
                                        diam eget risus varius blandit.</p><small>Donec id elit non mi
                                        porta.</small></a> <a
                                    ...
                                    <p class="mb-1 tx-13">Donec id elit non mi porta gravida at eget metus. Maecenas sed
                                        diam eget risus varius blandit.</p><small class="text-muted">Donec id elit non
                                        mi porta.</small></a> <a
                                    class="list-group-item list-group-item-action flex-column align-items-start"
                                    href="#">
                                    <div class="d-flex w-100 justify-content-between">
            ...
            <div class="card mg-b-20" id="list3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list03"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="list-group">
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
            ...
            <div class="card mg-b-20" id="list8">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="list08"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><ul class="list-group wd-md-100p users-list-group">
	<li class="list-group-item d-flex align-items-center">
