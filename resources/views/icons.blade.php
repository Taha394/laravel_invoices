...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Icons</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Icons</span>
            </div>
        </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">The world’s most popular and easiest to use icon set
                            just got an upgrade. More icons, More styles, More options .<span class="">See more FontAwesome icons at <a
                                    href="https://fontawesome.com/icons" target="_blank">FontAwesome Icons.</a></span>
                        </p>
                        <p><code>&lt;i class="far fa-ICON_NAME"&gt;&lt;/i&gt;</code>, <code>&lt;i class="fab
                                fa-ICON_NAME"&gt;&lt;/i&gt;</code></p>
                    </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Premium designed icons for use in web, iOS, Android,
                            and desktop apps. Support for SVG and web font.<span class="">See more Ionicons icons at <a
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Replace Font Awesome with modern line icons with a
                            single line of code.<span class="">See more Line Awesome icons at <a
                ...
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Typicons are free-to-use vector icons embedded in a
                            webfont for easy use in any UI, whether it be on the web or in a native app.<span class="">See more Typicons icons at <a
                                    href="https://www.s-ings.com/typicons/" target="_blank">Typicons Icons</a></span>
                        </p>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="">See more feather icons at <a
                                    href="https://feathericons.com/" target="_blank">Feather Icons</a></span></p>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="">See more material design icons at <a
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="">See more Themify icons at <a
                                    href="https://themify.me/themify-icons" target="_blank"> Themify Icons</a></span>
                        </p>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="">See more Crypto icons at <a
                                    href="http://cryptofont.com/" target="_blank"> Crypto Icons</a></span></p>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="">See more Simple line Icons at <a
