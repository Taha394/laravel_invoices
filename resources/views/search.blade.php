        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <h6 class="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                        fugiat nulla pariatur eu fugiat nulla pariatur</h6>
                    <p class="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut
            ...
            <div class="text-center search float-left">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="#"><i class="icon ion-ios-arrow-forward"></i></a>
                    </li>
