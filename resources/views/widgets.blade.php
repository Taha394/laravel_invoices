...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex"><h4 class="content-title mb-0 my-auto">Widgets</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Widgets</span></div>
        </div>
        ...
        <div class="col-sm-12 col-lg-6 col-xl-3">
            <div class="card card-img-holder">
                <div class="card-body list-icons">
                    ...
                    <div class="card-footer p-0">
                        <p class="text-muted mb-0 pt-4"><i class="si si-arrow-up-circle text-success mr-2"></i>Less
                            Sales</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="progress mt-4 ht-20">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning wd-60p ht-20">
                            36%
                        </div>
                    </div>
                </div>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">20% Off</span><br>on
                                    buy</h3>
                    ...
                    <div id="myCarousel0" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active flex-column">
                                ...
                                <h3 class="text-white font-light">Now Get <span class="font-bold">30% Off</span><br>on
                                    buy</h3>
                                <div class="text-white m-t-20">
                                    <i>- Alan Hemmings</i>
                                </div>
            ...
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">154<span class="text-success tx-13 ml-2">(+0.98%)</span>
                            </h4>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">5274<span class="text-danger tx-13 ml-2">(-12.45%)</span>
                            </h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1   font-weight-bold">76.3%<span
                                    class="text-success tx-13 ml-2">(+13.52%)</span></h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body iconfont text-right">
                    ...
                    <div class="d-flex mb-0">
                        <div class="">
                            <h4 class="mb-1 font-weight-bold">5m 24s<span
                                    class="text-success tx-13 ml-2">(+19.5%)</span></h4>
                            <p class="mb-2 tx-12 text-muted">Overview of Last month</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h3 mt-2 mb-2"><b>19.89K</b><span class="text-success tx-13 ml-2">(+25%)</span>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h3 mt-2 mb-2"><b>692</b><span class="text-success tx-13 ml-2">(+15%)</span>
                            </div>
                        </div>
                        <div class="col-auto align-self-center ">
                            <div class="feature mt-0 mb-0">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h3 mt-2 mb-2"><b>286</b><span class="text-success tx-13 ml-2">(+08%)</span>
                            </div>
                        </div>
                        <div class="col-auto align-self-center ">
                            <div class="feature mt-0 mb-0">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h3 mt-2 mb-2"><b>$2.98M</b><span class="text-success tx-13 ml-2">(+35%)</span>
                            </div>
                        </div>
                        <div class="col-auto align-self-center ">
                            <div class="feature mt-0 mb-0">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table class="table card-table country-table mb-0">
                        <tbody>
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="flags"
                        ...
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/spain_flag.jpg')}}" alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                            <td>Spain
                                <div class="progress progress-sm mt-1">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/germany_flag.jpg')}}" alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                            <td>Germany
                                <div class="progress progress-sm mt-1">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/russia_flag.jpg')}}" alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                            <td>Russia
                                <div class="progress progress-sm mt-1">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/italy_flag.jpg')}}" alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                            <td>Italy
                                <div class="progress progress-sm mt-1">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{URL::asset('assets/img/flags/french_flag.jpg')}}" alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></i></td>
                            <td>French
                                <div class="progress progress-sm mt-1">
                                    <div class="progress-bar bg-teal wd-40"></div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body pd-y-7">
                    ...
                    <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-15">Overall product rating
                        by the customers.</h6>
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <div class="card order-list">
                <div class="card-body">
                    ...
                    <p class="tx-12 tx-gray-500 mb-3">Order Activity is ecommerce platforms to track the orders placed
                        on their stores <a href="">Learn more</a></p>
                    <ul class="list list-noborders pb-0 mb-0">
                        <li class="list-item">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/03.jpg')}}"
                                     alt="thumb images">
                        ...
                        <li class="list-item">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/04.jpg')}}"
                                     alt="thumb images">
                        ...
                        <li class="list-item">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/06.jpg')}}"
                                     alt="thumb images">
                        ...
                        <li class="list-item">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/08.jpg')}}"
                                     alt="thumb images">
                        ...
                        <li class="list-item pb-0 mb-0">
                            ...
                            <div class="mr-auto d-flex">
                                <img class="img-sm ml-1" src="{{URL::asset('assets/img/ecommerce/02.jpg')}}"
                                     alt="thumb images">
        ...
        <div class="col-md-12 col-lg-6  col-xl-4">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-0">session by country mean that the user is from the stated country
                        or that the session is originating in the stated country. <a href="">Learn more</a></p>
                </div>
                <div class="card-body">
