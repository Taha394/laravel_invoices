                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code1" data-toggle="tab"
                                   href="#html-code1" role="tab" aria-controls="html-code1" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar1"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="demo-avatar-group">
	<div class="main-img-user avatar-xs">
            ...
            <div class="card custom-card" id="shapes">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar2"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="demo-avatar-group">
	<div class="main-img-user avatar-md">
		<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/faces/4.jpg')}}">
	</div>
            ...
            <div class="card custom-card" id="initials">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar3"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="demo-avatar-group avatar-list">
	<div class="avatar avatar-xs bg-primary rounded-circle">
		A
	</div>
	<div class="avatar avatar-sm bg-secondary rounded-circle">
            ...
            <div class="card custom-card" id="status">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="avatar4"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="demo-avatar-group">
	<div class="main-avatar avatar online">
