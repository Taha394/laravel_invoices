                    ...
                    <form action="form-validation.html" id="selectForm" name="selectForm">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 mg-t-10 mg-sm-t-0">
                                <button class="btn btn-main-primary pd-x-20" type="submit" value="5">Validate Form
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <form action="form-validation.html" data-parsley-validate="">
                        <div class="row row-sm">
                            ...
                            <div class="col-12">
                                <button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit">Validate Form
                                </button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form action="form-validation.html" data-parsley-validate="">
                        ...
                        <div class="parsley-checkbox" id="cbWrapper">
                            <label class="ckbox mg-b-5"><input data-parsley-class-handler="#cbWrapper"
                                                               ...
                                                               data-parsley-mincheck="2" name="browser[]" required=""
                                                               type="checkbox" value="1"><span>Firefox</span></label>
                            <label class="ckbox mg-b-5"><input name="browser[]" type="checkbox"
                                                               value="2"><span>Chrome</span></label> <label
                                class="ckbox mg-b-5"><input name="browser[]" type="checkbox"
