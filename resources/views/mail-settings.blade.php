    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex"><h4 class="content-title mb-0 my-auto">Mail</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Mail-setting</span></div>
        </div>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9 col">
                                    ...
                                    <label class="ckbox mg-b-10"><input checked=""
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <label class="ckbox mg-b-10"><input
                                            type="checkbox"><span>Require Personal Details</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
