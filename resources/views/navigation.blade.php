            ...
            <div class="card custom-card" id="basic">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav1"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><nav class="nav main-nav flex-column flex-md-row">
	<a class="nav-link active" href="#">Home</a>
	<a class="nav-link" href="#">About</a>
	<a class="nav-link" href="#">Pages</a>
	<a class="nav-link" href="#">Custom</a>
</nav></script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#nav1"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="vertical">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Below is an example of a basic navigation in a vertical
                            mode</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav2"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><nav class="nav main-nav-column">
	<a class="nav-link active" href="#">Home</a>
	<a class="nav-link" href="#">About</a>
	<a class="nav-link" href="#">Pages</a>
	<a class="nav-link" href="#">Custom</a>
</nav></script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#nav2"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="pill">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav3"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><nav class="nav nav-pills flex-column flex-md-row">
	<a class="nav-link active" href="#">Home</a>
	<a class="nav-link" href="#">About</a>
	<a class="nav-link" href="#">Pages</a>
	<a class="nav-link" href="#">Custom</a>
</nav></script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#nav3"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="verticallpill">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Below is an example of a pill navigation in vertical
                            mode</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav4"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><nav class="nav nav-pills flex-column">
	<a class="nav-link active" href="#">Home</a>
	<a class="nav-link" href="#">About</a>
	<a class="nav-link" href="#">Pages</a>
	<a class="nav-link" href="#">Custom</a>
</nav></script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#nav4"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="hori">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">A navigation with center and right in which left is the
                            default.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav5"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="p-3 bg-light mb-3">
	<nav class="nav main-nav flex-column flex-md-row justify-content-center">
		<a class="nav-link active" href="#">Home</a>
		<a class="nav-link" href="#">About</a>
		<a class="nav-link" href="#">Pages</a>
...
<div class="p-3 bg-light border">
	<nav class="nav main-nav flex-column flex-md-row justify-content-end">
		...
		<a class="nav-link" href="#">Custom</a>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#nav5"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="colored">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav6"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="p-3 bg-primary mb-3">
	<nav class="nav main-nav main-nav-colored-bg main-nav-dark flex-column flex-md-row">
		<a class="nav-link active" href="#">Home</a>
		<a class="nav-link" href="#">About</a>
		<a class="nav-link" href="#">Pages</a>
...
<div class="p-3 bg-secondary">
	<nav class="nav main-nav main-nav-colored-bg main-nav-dark flex-column flex-md-row">
		...
		<a class="nav-link" href="#">Custom</a>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#nav6"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="underline">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Below is a type of navigation that have a line at the
                            bottom of active link.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
                            <div class="p-3 bg-light border">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav7"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><nav class="nav main-nav-line flex-column flex-md-row">
	<a class="nav-link active" data-toggle="tab" href="#">Home</a>
	<a class="nav-link" data-toggle="tab" href="#">About</a>
	<a class="nav-link" data-toggle="tab" href="#">Pages</a>
	<a class="nav-link" data-toggle="tab" href="#">Custom</a>
</nav></script></code></pre>
                            <div class="clipboard-icon" data-clipboard-target="#nav7"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card custom-card" id="tab">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="nav8"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="tab-content">
	<div class="tab-pane active show" id="tabCont1">
	...
	<div class="tab-pane" id="tabCont3">
		 Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#nav8"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
