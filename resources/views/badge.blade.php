            ...
            <div class="card mg-b-20" id="badge">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge01"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><h1>Heading 1 <span class="badge badge-light">New</span></h1>
<h2>Heading 2 <span class="badge badge-light">New</span></h2>
<h3>Heading 3 <span class="badge badge-light">New</span></h3>
<h4>Heading 4 <span class="badge badge-light">New</span></h4>
<h5>Heading 5 <span class="badge badge-light">New</span></h5>
            ...
            <div class="card mg-b-20" id="badge1">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge02"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><h1 class="text-primary">Heading 1 <span class="badge badge-primary">New</span></h1>
<h2  class="text-danger">Heading 2 <span class="badge badge-danger">New</span></h2>
<h3  class="text-warning">Heading 3 <span class="badge badge-warning">New</span></h3>
<h4  class="text-success">Heading 4 <span class="badge badge-success">New</span></h4>
<h5  class="text-info">Heading 5 <span class="badge badge-info">New</span></h5>
            ...
            <div class="card mg-b-20" id="badge2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge03"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><span class="badge badge-primary">Primary</span>
<span class="badge badge-secondary">Secondary</span>
<span class="badge badge-success">Success</span>
<span class="badge badge-danger">Danger</span>
<span class="badge badge-warning">Warning</span>
            ...
            <div class="card mg-b-20" id="badge3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge04"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><span class="badge badge-pill badge-primary">Primary</span>
<span class="badge badge-pill badge-secondary">Secondary</span>
<span class="badge badge-pill badge-success">Success</span>
<span class="badge badge-pill badge-danger">Danger</span>
<span class="badge badge-pill badge-warning">Warning</span>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card mg-b-20" id="badge4">
                <div class="card-body">
                    ...
                    <p class="mg-b-20 text-muted card-sub-title">Using the contextual badge classes on an element
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge05"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><a class="badge badge-primary" href="#">Primary</a>
<a class="badge badge-secondary" href="#">Secondary</a>
<a class="badge badge-success" href="#">Success</a>
<a class="badge badge-danger" href="#">Danger</a>
<a class="badge badge-warning" href="#">Warning</a>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card mg-b-20" id="badge5">
                <div class="card-body">
                    ...
                    <p class="mg-b-20 text-muted card-sub-title">Badges can be used as part of links or buttons to
                        provide a counter.</p>
                    <div class="text-wrap">
                        <div class="example">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight clip-widget" id="badge06"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><button type="button" class="btn btn-primary mt-1 mb-1">Primary <span class="badge badge-light">22</span></button>
