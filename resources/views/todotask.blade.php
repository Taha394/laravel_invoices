                ...
                <div class="col-lg-12">
                    <div class="card mg-b-20">
                        <div class="card-body d-flex p-3">
                            ...
                            <div class="mr-auto"><a class="d-block tx-20" data-placement="top" data-toggle="tooltip"
                                                    title="Add New User" href="#"><i class="si si-plus text-muted"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mg-b-20">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class="drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                           class="rounded-circle avatar avatar-md "
                                                                                           src="{{URL::asset('assets/img/faces/1.jpg')}}"><span
                                ...
                                <div class="mr-auto">
                                    <div class="">
                                        <a href="#" data-placement="top" data-toggle="tooltip" title="archive"
                                           class="p-2 text-muted"><i class="fas fa-envelope-open-text"></i></a>
                                        <a href="#" data-placement="top" data-toggle="tooltip" title="Move to spam"
                                           class="p-2 text-muted"><i class="fas fa-exclamation-circle"></i></a>
                                        <a class="p-2 text-muted" data-toggle="dropdown"><i
                            ...
                            <div class="p-4">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-primary-transparent text-primary mr-auto float-left">New task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Work Assigned by Clients ,try to get new
                                    work</h5>
                            </div>
                            <div class="p-4 border-top">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-danger-transparent text-danger mr-auto float-left">Pending task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Sed ut perspiciatis unde omnis iste
                                    natus</h5>
                            </div>
                        </div>
                        <div class="card-footer ">
                            <a class="btn btn-primary disabled" href="#" title="Assign Task">Assign</a>
                            <a class="btn btn-outline-primary mr-auto float-left" href="#" data-placement="top"
                               data-toggle="tooltip" title="View Task">View All</a>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                    ...
                    <div class="card mg-b-20">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class="drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                           class="rounded-circle avatar avatar-md "
                                                                                           src="{{URL::asset('assets/img/faces/12.jpg')}}"><span
                        ...
                        <div class="card-footer ">
                            <a class="btn btn-primary" href="#" data-placement="top" data-toggle="tooltip"
                    ...
                    <div class="card mg-b-20">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class="drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                           class="rounded-circle avatar avatar-md "
                                                                                           src="{{URL::asset('assets/img/faces/9.jpg')}}"><span
                            ...
                            <div class="p-4">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-primary-transparent text-primary mr-auto float-left">New task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Nemo enim ipsam voluptatem quia
                                    voluptas</h5>
                            </div>
                            <div class="p-4 border-top">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-danger-transparent text-danger mr-auto float-left">Pending task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">vero eos et accusamus et iusto odio
                                    dignissimos</h5>
                            </div>
                        </div>
                        <div class="card-footer ">
                    ...
                    <div class="card mg-b-20 mg-lg-b-0">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class="drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                           class="rounded-circle avatar avatar-md "
                                                                                           src="{{URL::asset('assets/img/faces/4.jpg')}}"><span
                            ...
                            <div class="p-4">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-primary-transparent text-primary mr-auto float-left">New task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Ut enim ad minima veniam nostrum
                                    exercitationem</h5>
                            </div>
                            <div class="p-4 border-top">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-danger-transparent text-danger mr-auto float-left">Pending task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Quis autem vel eum iure reprehenderit
                                    qui</h5>
                            </div>
                        </div>
                        <div class="card-footer ">
                            <a class="btn btn-primary disabled" href="#" data-placement="top" data-toggle="tooltip"
                               title="Assign Task">Assign</a>
                            <a class="btn btn-outline-primary mr-auto float-left" href="#" data-placement="top"
                               data-toggle="tooltip" title="View Task">View All</a>
                        </div>
                    ...
                    <div class="card mg-b-20 mg-lg-b-0">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class=" drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                            class="rounded-circle avatar avatar-md"
                                                                                            src="{{URL::asset('assets/img/faces/15.jpg')}}"><span
                            ...
                            <div class="p-4">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-primary-transparent text-primary mr-auto float-left">New task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">I must explain to you how all this
                                    mistaken</h5>
                            </div>
                            <div class="p-4 border-top">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-danger-transparent text-danger mr-auto float-left">Pending task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">I will give you a complete account of the
                                    system</h5>
                            </div>
                        </div>
                        <div class="card-footer ">
                    ...
                    <div class="card mg-b-20 ">
                        <div class="card-body p-0">
                            <div class="todo-widget-header d-flex pb-2 pd-20">
                                <div class="drop-down-profile" data-toggle="dropdown"><img alt=""
                                                                                           class="rounded-circle avatar avatar-md "
                                                                                           src="{{URL::asset('assets/img/faces/5.jpg')}}"><span
                            ...
                            <div class="p-4">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-primary-transparent text-primary mr-auto float-left">New task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Rationally encounter quences extremely
                                    painful</h5>
                            </div>
                            <div class="p-4 border-top">
                                <span class="tx-12 text-muted">10.54am</span><span
                                    class="badge bg-danger-transparent text-danger mr-auto float-left">Pending task</span>
                                <h5 class="tx-14 mb-0 mg-t-5 text-capitalize">Which of us ever undertakes laborious
                                    physical</h5>
                            </div>
                        </div>
                        <div class="card-footer ">
