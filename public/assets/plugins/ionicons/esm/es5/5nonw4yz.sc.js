...
var Icon = function () {
    ...
    return e.prototype.componentWillLoad = function () {
        ...
        if (this.lazy && this.win && this.win.IntersectionObserver) {
            var r = this.io = new this.win.IntersectionObserver(function (e) {
        ...
        if (!this.isServer && this.isVisible) {
            var t = this.getUrl();
            t && getSvgContent(t).then(function (t) {
        ...
        return {
            role: "img",
            class: Object.assign({}, createColorClasses(this.color), (e = {}, e["icon-" + this.size] = !!this.size, e))
        }
    }, e.prototype.render = function () {
        return !this.isServer && this.svgContent ? h("div", {
            class: "icon-inner",
        ...
        get: function () {
            return {
                ariaLabel: {type: String, attr: "aria-label", reflectToAttr: !0, mutable: !0},
...
function getSvgContent(e) {
    ...
    return t || (t = fetch(e, {cache: "force-cache"}).then(function (e) {
        return e.ok ? e.text() : Promise.resolve(null)
    }), requests.set(e, t)), t
}

function getName(e, t, i, n) {
    return t = (t || "md").toLowerCase(), i && "ios" === t ? e = i.toLowerCase() : n && "md" === t ? e = n.toLowerCase() : e && (e = e.toLowerCase(), /^md-|^ios-|^logo-/.test(e) || (e = t + "-" + e)), "string" != typeof e || "" === e.trim() ? null : "" !== e.replace(/[a-z]|-|\d/gi, "") ? null : e
}
...
function validateContent(e, t, i) {
    if (t) {
        var n = e.createDocumentFragment(), r = e.createElement("div");
        r.innerHTML = t, n.appendChild(r);
        for (var o = r.childNodes.length - 1; o >= 0; o--) "svg" !== r.childNodes[o].nodeName.toLowerCase() && r.removeChild(r.childNodes[o]);
        var s = r.firstElementChild;
        if (s && "svg" === s.nodeName.toLowerCase() && (i && s.setAttribute(i, ""), isValid(s))) return r.innerHTML
    }
    return ""
}
...
function isValid(e) {
    if (1 === e.nodeType) {
        ...
        for (var t = 0; t < e.attributes.length; t++) {
            ...
            if ("string" == typeof i && 0 === i.toLowerCase().indexOf("on")) return !1
        }
        for (t = 0; t < e.childNodes.length; t++) if (!isValid(e.childNodes[t])) return !1
    }
    return !0
}
