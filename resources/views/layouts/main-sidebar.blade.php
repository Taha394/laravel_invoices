        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='home') }}">
                    ...
                    <span class="side-menu__label">{{__('messages.dashboard')}}</span><span
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">{{__('messages.invoices')}}</span><i
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">{{__('messages.reports')}}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                           href="{{ url('/' . $page='cards') }}">{{__('messages.reports invoices')}}</a></li>
                    <li><a class="slide-item"
                           href="{{ url('/' . $page='darggablecards') }}">{{__('messages.reports clients')}}</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">{{__('messages.users')}}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">{{__('messages.users list')}}</a>
                    </li>
                    <li><a class="slide-item"
                           href="{{ url('/' . $page='mail-compose') }}">{{__('messages.users privileges')}}</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">{{__('messages.settings')}}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                           href="{{ url('/' . $page='categories') }}">{{__('messages.categories')}}</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='products') }}">{{__('messages.product')}}</a>
                    </li>
                </ul>
            </li>
        </ul>
