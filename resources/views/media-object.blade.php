                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="media d-block d-sm-flex">
                                <img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0"
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="media-object01"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="media d-block d-sm-flex">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="media d-block d-sm-flex">
                                ...
                                <div class="media-body">
                                    <h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
                                    <p>Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia
                                    ...
                                    <div class="media d-block d-sm-flex mg-t-25">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
                                            Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="media-object02"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="media d-block d-sm-flex">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="media d-block d-sm-flex">
                                <img alt=""
                                     class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0 align-self-center"
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="media-object03"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="media d-block d-sm-flex">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="media d-block d-sm-flex">
                                ...
                                <img alt="" class="main-img-user avatar-lg mg-sm-r-20 mg-t-20 mg-sm-t-0"
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="media-object04"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="media d-block d-sm-flex">
	<div class="media-body">
		<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
		Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
            ...
            <div class="card" id="media-object5">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="media-object05"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><ul class="list-unstyled mb-0">
	<li class="media d-block d-sm-flex">
