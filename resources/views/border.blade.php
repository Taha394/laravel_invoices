                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-3 col-md-4">
                            ...
                            <div class="p-3 p-3 bg-gray-100 bd-y bd-2 mt-4 mb-4 mb-xl-0">.border-top & .border-bottom
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 col-md-4">
                            <div class="p-3 p-3 bg-gray-100 bd-r bd-2">.border-right</div>
                            <div class="p-3 p-3 bg-gray-100 bd-x bd-2 mt-4 mb-4 mb-xl-0">.border-left & .border-right
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 col-md-4">
                    ...
                    <div class="table-responsive mg-t-20 mb-0">
                        <table class="table main-table-reference text-nowrap mg-b-0 mg-t-0">
                            ...
                            <tr>
                                ...
                                <td>primary | success | warning | danger | info | indigo | purple | pink | teal |
                                    orange
                                </td>
