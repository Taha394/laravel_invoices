...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex"><h4 class="content-title mb-0 my-auto">Apps</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Cards</span></div>
        </div>
        ...
        <div class="col-12  col-lg-12 col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis
        ...
        <div class="col-md">
            <div class="card card-body bg-gray-200 bd-0">
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                    card's content. Lorem ipsum dolor sit amet consictetur...</p>
            </div>
        </div>
        ...
        <div class="col-md">
            <div class="card bg-gray-200 bd-0">
                <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                        card's content.</p><a class="card-link" href="#">Card link</a> <a class="card-link" href="#">Another
                        link</a>
                </div>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-md-4 col-lg-4">
            <div class="card">
                ...
                <img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('assets/img/photos/1.jpg')}}"></div>
        </div><!-- col-4 -->
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                <div class="card-body ">
                ...
                <img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('assets/img/photos/2.jpg')}}"></div>
        </div><!-- col-4 -->
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                <div class="card-body ">
                ...
                <img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('assets/img/photos/11.jpg')}}"></div>
        </div><!-- col-4 -->
    </div>
    <!-- /row closed -->
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
                    ...
                    <p class="tx-white-7 tx-13">Some quick example text to build on the card title and make up the bulk
                        of the card's content. Lorem ipsum dolor sit amet consictetur...</p>
    ...
    <div class="row row-sm">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body ">
                    <p class="mg-b-0">Some quick example text to build on the card title and make up the bulk of the
                        card's content. Lorem ipsum dolor sit amet consictetur...</p>
                </div>
            </div>
        </div>
