        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Elements</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Tabs</span>
            </div>
        </div>
            ...
            <div class="card" id="basic-alert">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Code -->
                        <figure class="highlight clip-widget" id="tabs"><pre><code class="language-markup"><script
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="tab3">
			...
			<p class="mb-0">similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.</p>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#tabs"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
            ...
            <div class="card mg-b-20" id="tabs-style2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight mb-0" id="element2"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="panel panel-primary tabs-style-2">
	<div class=" tab-menu-heading">
		<div class="tabs-menu1">
			<!-- Tabs -->
			<ul class="nav panel-tabs main-nav-line">
            ...
            <div class="card mg-b-20" id="tabs-style3">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight mb-0" id="element3"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="panel panel-primary tabs-style-3">
	<div class="tab-menu-heading">
		<div class="tabs-menu ">
			<!-- Tabs -->
			<ul class="nav panel-tabs">
            ...
            <div class="card" id="tabs-style4">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab24">
                                                <p>On the other hand, we denounce with righteous indignation and dislike
                                                    ...
                                                    the moment, so blinded by desire quod maxime placeat facere
                                                    possimus, omnis voluptas assumenda est, omnis dolor repellendus.</p>
                                                <p>On the other hand, we denounce with righteous indignation and dislike
                                                    men who are so beguiled and demoralized by the charms of pleasure of
                                                    the moment, so blinded by desire quod maxime placeat facere
                        ...
                        <!---Prism Pre code-->
                        <figure class="highlight mb-0" id="element4"><pre><code class="language-markup mb-0"><script
                                        type="prismsmix/javascript"><div class="d-md-flex">
	<div class="">
		<div class="panel panel-primary tabs-style-4">
			<div class="tab-menu-heading">
				<div class="tabs-menu ">
                ...
                <div class="text-wrap">
                                ...
                                <div class="content_wrapper">
                                    <div class="tab_content active">
                                        <p>Nor again is there anyone who loves or pursues or desires to obtain pain of
                                            ...
                                            one who avoids a pain that produces no resultant pleasure?</p>
                                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="default-tab" role="tabpanel" aria-labelledby="html-tab">
                            <!---Prism Pre code-->
                            <figure class="highlight mb-0" id="element5"><pre><code class="language-markup mb-0"><script
                                            type="prismsmix/javascript"><div class="panel panel-primary">
	<div class="tab_wrapper right_tab">
		<ul class="tab_list">
			<li class="active">Tab 1</li>
			<li>Tab 2</li>
			...
			<div class="tab_content">
				<p> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents .</p>
                        ...
                        <div class="tab-pane" id="default-tab1" role="tabpanel" aria-labelledby="js-tab">
                            <!---Prism Pre code-->
                            <figure class="highlight mb-0" id="element3"><pre><code class="language-markup"><script
                                            type="prismsmix/javascript"><!---Tabs JS-->
src="{{URL::asset('assets/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
                        ...
                        <div class="tab-pane" id="default-tab2" role="tabpanel" aria-labelledby="js-tab1">
                            <!---Prism Pre code-->
                            <figure class="highlight mb-0" id="element4"><pre><code class="language-markup"><script
                                            type="prismsmix/javascript"><!---Tabs scripts-->
